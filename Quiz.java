...
public class Quiz extends JFrame implements ActionListener {
    ...
    Quiz(String name){
        ...
        JLabel quiz = new JLabel(i1);
        quiz.setBounds(0,0,1450,300);
        add(quiz);
        
        number = new JLabel();
        number.setBounds(130,320,200,67);
        number.setFont(new Font("Tahoma",Font.PLAIN,20));
        add(number);
        
        question = new JLabel();
        question.setBounds(200,250,700,200);
        ...
        next.setBounds(1100,500,100,40);
        ...
        lifeline.setBounds(1100,580,150,40);
        ...
        submit.setBounds(1100,650,100,40);
        ...
        if(ans_given==1){
           ans_given =0;
            ...
            opt4.setEnabled(true);
             ...
             if (count==9){ // for auto submission....
                ...
                useranswers[count][0]=groupoption.getSelection().getActionCommand();
                 ...
                 for(int i = 0 ; i<useranswers.length;i++){
                     if(useranswers[i][0].equals(answers[1][i])){
                         score +=10;
                     }
